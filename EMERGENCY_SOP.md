...
1. **關機前報備** — 任何 bot 要下線，必須先在群組通知「[bot名] 準備關機」。不可無預警消失。
2. **回來時報到** — 重啟後在群組報到，確認能正常回應。
3. **點名機制** — 蝦老大隨時 @ 點名，2 分鐘內未回應視為故障。
...
| 🤖 大爆蝦 | Mac2024 | 192.168.1.103 | ❌ 待裝 | Mac2024 | 蝦老大 |
| 🦀 小爆蝦 | MacMini2012 | 192.168.1.111 | ❌ 待裝 | MacMini2012 | 蝦老大 |
